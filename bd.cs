...
namespace PROJETgesAMM
{
    public static class bd
    {
        ...
        {
            SqlCommand maRequete = new SqlCommand("prc_insererMedicament", Globale.cnx);
            //Procédure stockée
            maRequete.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public static int getNbAmmDate(string laDate)
        {
            SqlCommand maRequete = new SqlCommand("prc_NbAmmDate", Globale.cnx);
            //Procédure stockée
            maRequete.CommandType = System.Data.CommandType.StoredProcedure;

            SqlParameter Date = new SqlParameter("@DATE", System.Data.SqlDbType.Char, 20);
            Date.Value = laDate;
            ...
            while (sqlExec.Read())
            {
                 return int.Parse(sqlExec["NB"].ToString());
            }
            return -1;
        }
    }
